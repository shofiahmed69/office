...
async function main() {
  ...
  // 2. Create profile (for X-User-Id)
  ...
  // 6. GET /api/users/me/permissions
  ...
  // 8. PATCH /api/users/me/preferences
  ...
  // 9. GET /api/users/me/tags (empty initially)
  ...
  // 11. GET /api/users/me/tags (with data)
  ...
  // 12. DELETE /api/users/me/tags/:id
  if (tagId) {
  ...
  // 13. GET /api/users/me/ai-settings
  ...
  // 14. POST /api/users/me/ai-settings
  ...
  // 15. PATCH /api/users/me/ai-settings/:id
  if (aiSettingId) {
  ...
  // 16. DELETE /api/users/me/ai-settings/:id
  if (aiSettingId) {
